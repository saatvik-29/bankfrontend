          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              <div className="bg-white rounded-xl p-6 text-center shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-gray-600">
                  Get precise calculations based on current market rates and
                  banking standards
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 text-center shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-gray-600">
                  Instant calculations as you adjust loan amount, tenure, and
                  interest rates
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 text-center shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-gray-600">
                  All our financial calculators are completely free with no
                  hidden charges
                </p>
              </div>
            </div>
        ...
        <section className="py-16 bg-gradient-to-r from-blue-600 to-indigo-600">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Our financial experts are here to guide you through the loan
              process and help you make the best financial decisions.
            </p>
