        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-3 gap-8 max-w-3xl">
            <div className="text-center">
              <p className="text-3xl font-bold text-[#15803d]">9% - 15%</p>
          ...
          <div className="bg-gradient-to-br from-green-50 to-white rounded-2xl p-8 border border-green-200 shadow-lg max-w-2xl mx-auto">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center py-2 border-b border-green-100">
                ...
                <span className="font-semibold text-gray-900">₹15,00,000</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-green-100">
              ...
              <div className="flex justify-between items-center pt-4">
                ...
                <span className="text-3xl font-bold text-[#15803d]">₹20,758</span>
              </div>
            </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-700">Studies in India & abroad</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-[#15803d] mr-3 mt-0.5 flex-shrink-0" />
              ...
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-[#15803d] mr-3 mt-0.5 flex-shrink-0" />
                <span className="text-gray-700">Covers tuition & living expenses</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-[#15803d] mr-3 mt-0.5 flex-shrink-0" />
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                <span className="text-gray-700">Admission to recognized course</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                <span className="text-gray-700">Co-applicant required</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                <span className="text-gray-700">Good academic record</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                <span className="text-gray-700">Age: 16-35 years</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                <div className="w-2 h-2 bg-purple-500 rounded-full mr-3"></div>
                <span className="text-gray-700">Co-applicant documents</span>
              </li>
              <li className="flex items-center">
                <div className="w-2 h-2 bg-purple-500 rounded-full mr-3"></div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center py-2 border-b border-gray-200">
                ...
                <span className="font-semibold">1% of loan amount</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-gray-200">
              ...
              <div className="flex justify-between items-center py-2">
                <span className="text-gray-600">Moratorium:</span>
                <span className="font-semibold">Course + 6 months</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-green-100 mb-8">
              Get the funding you need for your dream education
            </p>
