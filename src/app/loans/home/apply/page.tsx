        ...
        <div className="max-w-2xl mx-auto px-4">
          <div className="bg-white rounded-xl shadow-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Your home loan application has been received. Our team will review it and get back to you within 24-48 hours via WhatsApp.
            </p>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="mb-8">
            <div className="flex items-center mb-4">
              <Button
                variant="outline"
                onClick={() => router.push('/loans/home')}
                className="mr-4"
              >
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Home Loan Application</h1>
                <p className="text-gray-600">Complete the form to apply for your home loan</p>
              </div>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button type="submit" className="w-full" disabled={loading}>
              {loading ? 'Submitting...' : 'Submit Home Loan Application'}
            </Button>
          </form>
        </div>
      </div>
