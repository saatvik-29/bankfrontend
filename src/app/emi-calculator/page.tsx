    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="mt-12 bg-white rounded-xl shadow-lg p-8">
          <h3 className="text-2xl font-bold text-gray-900 mb-6">How EMI is Calculated?</h3>
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h4 className="text-lg font-semibold text-gray-900 mb-4">EMI Formula</h4>
            ...
            <div>
              <h4 className="text-lg font-semibold text-gray-900 mb-4">Tips to Reduce EMI</h4>
              <ul className="space-y-2 text-gray-700">
                <li>• Choose a longer tenure to reduce monthly EMI</li>
                <li>• Make a higher down payment to reduce principal</li>
                <li>• Compare interest rates from different lenders</li>
                <li>• Consider part-prepayments to reduce interest burden</li>
